...
export default tseslint.config([
  ...
  },
  {
    ...
    rules: {
      ...
      // Complex restricted syntax rules
      'no-restricted-syntax': [
        ...
        // Temporarily disabled for LunchSelection component
        // {
      ...
      // Restricted imports (adapted for this project)
      'no-restricted-imports': [
        'error',
        {
          paths: [
            // You can add specific import restrictions here if needed
          ],
        },
      ],
    },
